        ...
        if not self.open:
            if self.possible_actions == None:
                ...
                for i in empty:
                    ...
                    if line[i[0]][1] < half and col[i[1]][1] < half and self.board.adjacent_vertical_numbers(i[0],i[1]).count(1)!=2 and self.board.adjacent_horizontal_numbers(i[0],i[1]).count(0)!=2:
