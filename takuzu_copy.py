...
class TakuzuState:
    ...
    def prioritize(self, actions): #para depois aplicar à actions a devolver
        ...
        for a in actions:
                ...
                elif self.board.get_number(a[0], a[1]-2)==1 and self.board.get_number(a[0], a[1]-1)==1:
                    #prioritize
                elif self.board.get_number(a[0], a[1]+1)==1 and self.board.get_number(a[0], a[1]+2)==1:
                    #prioritize
            else:
                if self.board.get_number(a[0]-2, a[1])==1 and self.board.get_number(a[0]-1, a[1])==1:
                    #priotitize
                elif self.board.get_number(a[0]+1, a[1])==1 and self.board.get_number(a[0]+2, a[1])==1:
                    #prioritize
                    ...
                    isto ia dar merda com os indices, caguei
                    """
